...
| namespace.mapper            | The strategy to use in determining the Mongo namespace the record should be written to.                                                                                                                                                                                                                                                                                                                                 | string  | TopicMongoMapper                                                             | [TopicMongoMapper, HeaderMongoMapper]                                                                                                                    | high       |
...
The `namespace.mapper` determines the namespace (database/collection) in Mongo that the data should be written to.

By default, `TopicMongoMapper` is used. This maps data from a single topic to a single namespace. Data from a topic **cannot** be split across namespaces.
Topic overrides can be utilized to modify this behavior. See the following section for more information on this.

The other built in mapper is the `HeaderMongoMapper`. For more details on this, see the [HeaderMongoMapper readme](./headermapper.md).
